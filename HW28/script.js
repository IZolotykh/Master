const getBtn = document.querySelector('.wrapper .requestBttn');
const txtMessage = document.querySelector(".txtMessage");
txtMessage.style.margin = "10px 0";
...
function serviceAvailable() {
  fetch('/serviceavailable/')
    ...
    .then(res => {
      ...
      txtMessage.innerHTML = "Произошла ошибка";
      else {
        Promise.allSettled([
          ...
          results.forEach((item) => {
            ...
            txtMessage.innerHTML = txtMessage.innerHTML + item.value.text + ' ';
          });
        })
      }
    })
